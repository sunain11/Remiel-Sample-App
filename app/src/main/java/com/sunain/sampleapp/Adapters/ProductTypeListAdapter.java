...
public class ProductTypeListAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    ...
    public ProductTypeListAdapter(Context context, ArrayList<String> strings) {
